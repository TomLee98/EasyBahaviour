classdef ObjectMatcher
    ...
    methods(Access = public)
        function [matched, new, lost, cost] = match(this, predicted, observed)
            ...
            observed(new) = [];
            CostMat(ismember(new, keys_observed), :) = [];
            keys_observed(ismember(new, keys_observed)) = [];
            ...
            predicted(lost) = [];
            CostMat(:, ismember(lost, keys_predicted)) = [];
            keys_predicted(ismember(lost, keys_predicted)) = [];
